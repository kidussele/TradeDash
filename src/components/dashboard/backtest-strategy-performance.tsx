...
export function BacktestStrategyPerformance({ entries, strategies }: StrategyPerformanceProps) {
            ...
            {performanceData.length > 0 ? (
                <Table>
                 ...
                 <div className="text-center py-10 text-muted-foreground">
                    ...
                    <p className="text-xs">Assign strategies to your backtest entries to see results.</p>
                </div>
            )}
        </CardContent>
    </Card>
